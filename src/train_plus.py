...
def train_model(args):
    ...
    model = EncoderViTPlus(ckpt_path='./checkpoint/ChairV2/model_Best.pth')
    # model = EncoderViTPlus(ckpt_path='./checkpoint/ShoeV2/model_Best.pth')
    # model = EncoderViTPlus(ckpt_path='./checkpoint/ClothesV1/model_Best.pth')
